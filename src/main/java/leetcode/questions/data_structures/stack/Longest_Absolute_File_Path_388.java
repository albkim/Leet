...
/**
 ...
 Seems like i can use a stack and pop it based on number of tab chars (if length < current number of tabs, keep pushing
 else pop until i get to parent) If I were to store last index of each folder. I can do a simple peek to get current length

 ah also need to only count files
