...
/**
 ...
 As we do in order, we want to find the node where we satisfy this condition
   ...
   the trick with binary tree opposed to binary search tree is that it should be by ref rather than by value
   since it's possible to have duplicates

 */
public class Lowest_Common_Ancestor_Binary_Tree_236 {
