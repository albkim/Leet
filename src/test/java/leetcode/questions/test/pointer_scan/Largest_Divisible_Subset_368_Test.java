...
import leetcode.questions.pointer_scan.Largest_Divisible_Subset_368;
...
/**
 * Created by albertk on 9/1/16.
 */
public class Largest_Divisible_Subset_368_Test {

    @Test
    public void testSample() {
        List<Integer> result = Largest_Divisible_Subset_368.largestDivisibleSubset(new int[] {1,2,3});
    ...
    public void testSample2() {
        List<Integer> result = Largest_Divisible_Subset_368.largestDivisibleSubset(new int[] {1,2,4,8});
    ...
    public void testSample3() {
        List<Integer> result = Largest_Divisible_Subset_368.largestDivisibleSubset(new int[] {1,2,4,8,16,32,64,128,256,512,1024,2048,4096,8192,16384,32768,65536,131072,262144,524288,1048576,2097152,4194304,8388608,16777216,33554432,67108864,134217728,268435456,536870912,1073741824});
    ...
    public void testSample4() {
        ...
        assertEquals(18, result.get(3).intValue());
        assertEquals(90, result.get(4).intValue());
        assertEquals(180, result.get(5).intValue());
        assertEquals(360, result.get(6).intValue());
        assertEquals(720, result.get(7).intValue());
    }
